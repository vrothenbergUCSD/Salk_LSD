...
def train_until(max_iteration):
    ...
    # "input_shape": [96, 484, 484], "output_shape": [60, 272, 272]
    input_size = Coordinate(config["input_shape"]) * voxel_size # 96*50, 484*10, 484*10 = 4800, 4840, 4840
    output_size = Coordinate(config["output_shape"]) * voxel_size

    # max labels padding calculated
    # labels_padding = Coordinate((840, 720, 720))
    labels_padding = Coordinate((1000, 1000, 1000))
